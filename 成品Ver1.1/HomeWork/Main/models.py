...
class Task(models.Model):
    ...
    task_uploadname = models.ForeignKey("Student",on_delete=None,null=True,blank=True,verbose_name=u"上传用户")
    ...
    task_grade      = models.ForeignKey("abc",verbose_name=u"作业的班级",on_delete=None)
...
class Question(models.Model):
    ...
    question_who = models.ForeignKey("Teacher",on_delete=None)
    question_grade = models.ForeignKey("abc",on_delete=None,null=True,blank=True)
    def __str__(self):
...
class Answer(models.Model):
    ...
    answer_who= models.ForeignKey("ID",on_delete=None)
...
class Thread(models.Model):
    ...
    thread_question=models.ForeignKey("Question",on_delete=models.CASCADE)
    thread_who = models.ForeignKey("ID",on_delete=None)
    thread = models.TextField(max_length=16000)
    thread_answer=models.ForeignKey("Answer",on_delete=models.CASCADE,blank=True,null=True)
    def __str__(self):

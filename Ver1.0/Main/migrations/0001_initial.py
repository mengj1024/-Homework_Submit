# Generated by Django 2.1.7 on 2019-03-23 07:33
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('question_grade', models.OneToOneField(on_delete=None, to='Main.abc')),
            ],
            options={
                'verbose_name': '头脑风暴',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('task_grade', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='Main.abc', verbose_name='作业的班级')),
                ('task_score', models.OneToOneField(blank=True, null=True, on_delete=None, to='Main.Score', verbose_name='作业分数')),
                ('task_uploadname', models.OneToOneField(on_delete=None, to='Main.Student', verbose_name='上传用户')),
            ],
            options={
                'verbose_name': '作业管理',
        ...
        migrations.AddField(
            model_name='question',
            name='question_who',
            field=models.OneToOneField(on_delete=None, to='Main.Teacher'),
        ),
        migrations.AddField(
            model_name='answer',
            name='answer_who',

...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('chengji_Type', models.CharField(max_length=5, verbose_name='成绩')),
            ],
            options={
                'verbose_name': '成绩分级',
                'verbose_name_plural': '成绩分级',
                'db_table': 'Chengji',
            },
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('hw_chengji', models.OneToOneField(blank=True, on_delete=None, to='Login.Chengji')),
            ],
            options={
                'verbose_name': '作业查看',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('students_grade', models.ForeignKey(on_delete=None, to='Login.Grade')),
            ],
            options={
                'verbose_name': '学生管理',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('add_time', models.DateTimeField(default=datetime.datetime.now, verbose_name='加入时间')),
                ('stu_chengji', models.ForeignKey(on_delete=None, to='Login.Chengji', verbose_name='成绩发布')),
